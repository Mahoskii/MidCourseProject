...
public class GameRoundManager : MonoBehaviour
{
    ...
    {
        CallPopUp(gameData.PopUpTitleList[0], gameData.PopUpContentList[0], gameData.PopUpCondition[0]);
    }

    public void OnRoundStart()
    {
        CallPopUp(gameData.PopUpTitleList[1]+ (gameData.mainIndex + 1), gameData.PopUpContentList[1], gameData.PopUpCondition[1]);
    }

    public void RoundFail()
    {
        CallPopUp(gameData.PopUpTitleList[2], gameData.PopUpContentList[2], gameData.PopUpCondition[0]);
        audioManager.PlaySFX(audioManager.roundFail);
    }

    public void OnGameLose()
    {
            CallPopUp(gameData.PopUpTitleList[3], gameData.PopUpContentList[3], gameData.PopUpCondition[2]);
            audioManager.PlaySFX(audioManager.gameOver);
    }

    public void RoundPass()
    {
        CallPopUp(gameData.PopUpTitleList[4], gameData.PopUpContentList[4], gameData.PopUpCondition[0]);
    }

    public void OnGameWin()
    {
            CallPopUp(gameData.PopUpTitleList[5], gameData.PopUpContentList[5], gameData.PopUpCondition[2]);
    ...
    {
        gameData.popUpTitleForThisCase = titleMessage;
        gameData.popUpContentForThisCase = contentMessage;
        gameData.popUpConditionForThisCase = gameoutCome;
        onPopUPCall.Raise();
    }
}
